...
@spimex_router.get('/trading_dates', response_model=list[date])
...
@spimex_router.get('/results-by-date', response_model=list[TradingResultsDB])
...
@spimex_router.get('/last-results', response_model=list[TradingResultsDB])
